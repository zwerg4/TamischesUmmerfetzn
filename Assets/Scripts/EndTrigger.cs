...
public class EndTrigger : MonoBehaviour
{
    ...
    void OnTriggerEnter()
    {
		...
		RestClient.Get<RecordObject>("https://tamischesummerfetzn.firebaseio.com/track1.json").Then(response =>
		{
    ...
    {
    	Debug.Log("BUTTON PRESSED, place: " + place);
	   ...
	   RestClient.Put("https://tamischesummerfetzn.firebaseio.com/track1.json", Countdown.Rec);
